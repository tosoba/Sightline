...
namespace {
    constexpr char VERTEX_SHADER_SRC_NO_BLUR[] = R"SRC(#version 300 es
...
void main() {
    ...
    constexpr char VERTEX_SHADER_SRC_TRANSFORM[] = R"SRC(#version 300 es
precision mediump float;
precision mediump int;
...
void main() {
    ...
    constexpr char VERTEX_SHADER_SRC_NO_TRANSFORM[] = R"SRC(#version 300 es
precision mediump float;
precision mediump int;
...
void main() {
    ...
    constexpr char FRAGMENT_SHADER_SRC_NO_BLUR[] = R"SRC(#version 300 es
...
void main() {
    ...
    constexpr char FRAGMENT_SHADER_SRC_V_OES[] = R"SRC(#version 300 es
...
void main() {
    ...
    constexpr char FRAGMENT_SHADER_SRC_V_2D[] = R"SRC(#version 300 es
precision mediump float;
precision mediump int;
...
void main() {
    ...
    constexpr char FRAGMENT_SHADER_SRC_H[] = R"SRC(#version 300 es
precision mediump float;
precision mediump int;
...
void main() {
    ...
    struct NativeContext {
        ...
        static constexpr GLfloat MAX_CONTRASTING_COLOR_MIX = .025f;
